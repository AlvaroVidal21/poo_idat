...
class ArregloClientes:
    ...
    def cargar(self):
        ...
        Si el archivo no existe, se crea inmediatamente con solo la fila de
        encabezados para mantener una estructura consistente.
        """
        if not os.path.exists(self.__archivo):
            # Crear el archivo con los encabezados y terminar
